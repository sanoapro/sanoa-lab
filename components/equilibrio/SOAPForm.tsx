  ...
  return (
    <div className="space-y-3">
      <label className="block">
        ...
        <textarea aria-label="Subjetivo" className="w-full border p-2 rounded" rows={4} value={S} onChange={e=>setS(e.target.value)} />
      </label>

      <label className="block">
        <span className="text-sm">O — Objetivo</span>
        <textarea aria-label="Objetivo" className="w-full border p-2 rounded" rows={4} value={O} onChange={e=>setO(e.target.value)} />
      </label>

      <label className="block">
        <span className="text-sm">A — Análisis</span>
        <textarea aria-label="Análisis" className="w-full border p-2 rounded" rows={4} value={A} onChange={e=>setA(e.target.value)} />
      </label>

      <label className="block">
        <span className="text-sm">P — Plan</span>
        <textarea aria-label="Plan" className="w-full border p-2 rounded" rows={4} value={P} onChange={e=>setP(e.target.value)} />
      </label>
