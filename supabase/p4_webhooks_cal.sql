...
-- 2) Ampliamos patient_appointments para reflejar estado y timestams de sync
do $$
begin
  if not exists (
...
--    Permite SELECT a dueños del paciente y compartidos (si paciente no está eliminado)
--    vía la relación con patient_appointments.cal_uid
