...
export async function POST(req: Request){
  ...
  const { patient_id, admission_at=null, discharge_at=null, diagnosis, summary, recommendations, follow_up_at=null } = body || {};
  ...
  const payload = { org_id, patient_id, doctor_id: user.id, admission_at, discharge_at, diagnosis, summary, recommendations, follow_up_at };
