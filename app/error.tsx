...
export default function Error({
  ...
  useEffect(() => {
    ...
    // console.error((error) instanceof Error ? error : (()=>{ try { return JSON.stringify(error); } catch { return String(error); }})());
  }, [error]);
      ...
      <div className="w-full max-w-3xl rounded-3xl bg-white/95 shadow-xl ring-1 ring-[var(--color-brand-border)]">
        <div className="p-8 md:p-10">
          <div className="flex items-center gap-3 mb-2">
            <ColorEmoji token="alerta" size={34} className="shrink-0" />
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            >
              <ColorEmoji token="copiar" size={18} />
              Copiar detalle
            </button>
